...
const InfoCard = ({ img, location, title, description, star, price, total }) => {
    return (
        <div className="flex py-7 border-b cursor-pointer hover:opacity-80 hover:shadow-lg pr-5 transition duration-200 ease-out first:border-t">
            ...
            <div className="flex flex-col flex-grow pl-5">
                ...
                <p
                    className="pt2 text-sm text-gray-500 flex-grow">
                    {description}
                </p>
